...
python3 -m pip install -r /home/ubuntu/tasks/requirements.txt
python3 /home/ubuntu/tasks/manage.py migrate
...
python3 /home/ubuntu/tasks/manage.py createsuperuser --noinput
